...
<body>
    <div class="comment_wrapper">
		...
		if (isset($_POST['postComment' . $post_id])) {
			...
			$insert_post = mysqli_query($con, "INSERT INTO comments (post_body, courseCode, posted_by, posted_to, date_added, removed, post_id) VALUES ('$post_body','$courseCode', '$userLoggedIn', '$posted_to', '$date_time_now', 'no', '$post_id')");
