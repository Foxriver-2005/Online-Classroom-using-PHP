...
class User2{
	...
	public function insertNotification($post_id, $user_to, $type) {
		...
		$insert_query = mysqli_query($this->con, "INSERT INTO notifications (user_to, user_from, message, link, datetime, opended, viewed) VALUES ('$user_to', '$userLoggedIn', '$message', '$link', '$date_time', 'no', 'no')");
	}
